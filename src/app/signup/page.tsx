...
const SignupPage = () => {
  ...
  const passwordRules = [
    { label: 'Between 10 and 24 characters', valid: formData.password.length >= 10 && formData.password.length <= 24 },
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md bg-white shadow-md rounded-lg p-6 sm:p-8">
        <div className="text-center mb-2">
          <h1 className="text-3xl font-extrabold text-blue-700 tracking-wide">CoDoc</h1>
          <p className="text-sm text-gray-500">Your reliable PDF collaboration tool</p>
        </div>

        <h2 className="text-2xl font-bold text-center text-gray-900 mb-6">Create your CoDoc account</h2>
